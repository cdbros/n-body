...
ControlPanelWidget::ControlPanelWidget(QWidget *parent) : QWidget{parent} {
    ...
    m_section1Layout->addWidget(new QLabel("This is section 1 text", m_section1.get()));
    ...
    m_section2Layout->addWidget(new QLabel("This is section 2 text", m_section2.get()));
    ...
    m_section3Layout->addWidget(new QLabel("This is section 3 text", m_section3.get()));
    ...
    m_section4Layout->addWidget(new QLabel("This is section 4 text", m_section4.get()));
